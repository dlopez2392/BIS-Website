...
export function IndustryCard({ label, title, body, href }: { label: string; title: string; body: string; href: string }) {
  return (
    <Link
      href={href}
      className="group flex flex-col rounded-card border border-hairline bg-surface-alt p-6 motion-safe:transition hover:border-link hover:bg-surface focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-link"
    >
